...
public class PodcastController {
    ...
    @GetMapping("/episodes/latest")
    public Episode getLatestEpisode() {
        // 實作邏輯：只需抓取 RSS 並回傳清單中的第一個物件即可
        return podcastService.fetchEpisodes().get(0);
    }

    @GetMapping("/recommended-keywords")
    public List<String> getRecommendedKeywords() {
        return Arrays.asList(
                "經典賽 | WBC", "好書我來讀", "好劇我來看", "人物我來講", "轉學生週記", "數據單元", "張育成", "鄭宗哲", "紅襪", "洋基", "道奇", "大都會", "教士", "太空人", "雙城", "光芒", "水手", "勇士", "天使", "費城人", "運動家", "白襪",
